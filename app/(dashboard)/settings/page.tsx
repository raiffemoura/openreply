...
export default function SettingsPage() {
  ...
  async function disconnectInstagram(instagramAccountId: string) {
    if (!confirm("Desconectar o Instagram? As campanhas dessa conta vão parar de enviar DMs.")) {
      return;
    }
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-3 py-3 border-b border-border">
            <div>
              ...
              <p className="text-xs text-muted mt-0.5">
                Os webhooks de comentário e as respostas privadas dependem dessa conexão.
              </p>
            </div>
            <span
          ...
          <div className="flex items-center justify-between gap-3 py-3 border-b border-border">
            <div>
              ...
              <p className="text-xs text-muted mt-0.5">
                {accounts.length} perfil{accounts.length === 1 ? "" : "is"} do Instagram
      ...
      <section className="panel rounded p-4 sm:p-6">
        ...
        <div className="flex items-center justify-between gap-3 py-3">
          <div>
            ...
            <p className="text-xs text-muted mt-0.5">
              Self-hosted — sem limites de plano.
            </p>
          </div>
