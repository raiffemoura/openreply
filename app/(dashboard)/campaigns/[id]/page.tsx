...
export default function CampaignDetailPage() {
  ...
  const matchText = campaign.matchAnyWord
    ? "Qualquer comentário"
    : campaign.keywords.join(", ") || "Nenhuma palavra-chave";
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,340px)_1fr]">
      ...
      <div className="space-y-6">
        ...
        <Summary title="Quando alguém comenta em">
        ...
        <Summary title="E esse comentário tem">
          <FieldBox>{matchText}</FieldBox>
          {campaign.dmTriggerEnabled && (
            <p className="text-xs text-muted">
              Também responde quando alguém manda DM com{" "}
        ...
        {campaign.openingDmEnabled && (
          <Summary title="Eles vão receber uma DM inicial">
          ...
          <Summary title="Eles precisam seguir primeiro">
            <FieldBox>
              {campaign.followPromptMessage ||
                "um favor rápido antes de eu mandar seu link. eu não ganho nada com isso, é grátis. se quiser me apoiar, só não deixe de me seguir depois, e dê uma estrela no repositório do github se isso te ajudar. toque no botão assim que estiver seguindo e eu mando pra você"}
            </FieldBox>
            <FieldBox>
              {campaign.followPromptButtonLabel || "estou seguindo"}
            </FieldBox>
          </Summary>
        )}

        <Summary title="E então, eles vão receber uma DM">
        ...
        {campaign.followUpEnabled && campaign.followUpMessage && (
          <Summary title="Depois, uma mensagem de follow-up">
      ...
      <div className="space-y-4">
        ...
        {tab === "preview" && (
          ...
          <CampaignPreview
            ...
            postThumb={postThumb}
            caption=""
            sampleComment={campaign.matchAnyWord ? "amei!" : campaign.keywords[0] ?? "LINK"}
