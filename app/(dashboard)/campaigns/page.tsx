      ...
      {automations.length === 0 && (
        <div className="panel rounded p-8 text-center sm:p-12">
          ...
          <p className="text-sm text-muted mb-6 max-w-sm mx-auto">
            Crie sua primeira campanha de comentário para DM e transforme uma publicação ou reels num fluxo de conversa mensurável.
          </p>
          <Link
            href="/campaigns/new"
            ...
            <div className="flex flex-wrap items-start gap-x-4 gap-y-3">
              {auto.postId && thumbnails[auto.postId] && (
                videoUrl ? (
                  <button
                    ...
                    aria-label="Reproduzir prévia do reels"
                    className="shrink-0"
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src={thumbnails[auto.postId]}
                      alt="Reels da campanha"
              ...
              <div className="min-w-[12rem] flex-1">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-3 text-xs text-zinc-500">
                  ...
                  <span>·</span>
                  <span>{auto.analytics.skipped} ignorados</span>
                  <span>·</span>
